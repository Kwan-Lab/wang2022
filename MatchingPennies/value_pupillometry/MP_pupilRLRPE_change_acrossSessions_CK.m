function MP_pupilRLRPE_change_acrossSessions_CK(dataIndex, savefigpath);
...
tlabel1={'c(n)','c(n-1)','r(n-1)','Q_L-Q_R', 'RPE', 'C_L-C_R', 'CKE', 'Average reward', 'Cumulative reward'};
...
reg_all_pos.coeff= all_coeff_pos(:,:,1:55);
reg_all_pos = getBootstrp(reg_all_pos,0,0.05);

reg_all_neg = reg_all;
reg_all_neg.coeff= all_coeff_neg(:,:,1:55);
