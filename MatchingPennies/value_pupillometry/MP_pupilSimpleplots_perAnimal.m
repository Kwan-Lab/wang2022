function MP_pupilSimpleplots_perAnimal(dataIndex,modelpath, savefigpath)
...
for j = 1:numel(animalList)
    ...
    pennies_pupilSimpleplots_perAnimal(dataIndex(currAnimalSessions,:), modelpath, savefigpath, j);
end
