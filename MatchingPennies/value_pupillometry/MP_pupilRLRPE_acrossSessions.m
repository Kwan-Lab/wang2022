function MP_pupilRLRPE_acrossSessions(dataIndex, savefigpath);
...
print(gcf,'-dpng','MLR-RL_averageSession_RPE-coeff');    %png format
saveas(gcf, 'MLR-RL_averageSession_RPE-coeff', 'fig');


% plot updatedQ

MP_plot_regrcoef_pupil(reg_all_updatedQ,pvalThresh,tlabel2,xtitle);
print(gcf,'-dpng','MLR-RL_averageSession_updatedQ-coeff');    %png format
saveas(gcf, 'MLR-RL_averageSession_updatedQ-coeff', 'fig');
...
print(gcf,'-dpng','MLR-RL_RPE-sig');    %png format
saveas(gcf, 'MLR-RL_RPE-sig', 'fig');
...
print(gcf,'-dpng','MLR-RL_updatedQ-sig');    %png format
saveas(gcf, 'MLR-RL_updatedQ-sig', 'fig');
