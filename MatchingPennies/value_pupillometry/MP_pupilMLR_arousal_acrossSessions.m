function MP_pupilMLR_arousal_acrossSessions(dataIndex, savefigpath)
...
for ii = 1:nFiles
    ...
    saveRegName = fullfile(savematpath,[fn_beh.name(1:end-7),'regCR_change_arousal.mat']);
...
print(gcf,'-dpng','MLR-change-choiceoutcome_arousal_averageSession');    %png format
saveas(gcf, 'MLR-change-choiceoutcome_arousal_averageSession', 'fig');
saveas(gcf, 'MLR-change-choiceoutcome_arousal_averageSession','svg');
