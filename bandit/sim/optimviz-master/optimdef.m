...
optims = [];
optims{end+1} = {'BADS', @(fun,x0,LB,UB) bads(fun,x0,LB,UB,LB,UB,[],[],stats)};
optims{end+1} = {'fminsearch', @(fun,x0,LB,UB) fminsearch(fun,x0,[],stats)};
optims{end+1} = {'fmincon', @(fun,x0,LB,UB) fmincon(fun,x0,[],[],[],[],LB,UB,[],[],stats)};
