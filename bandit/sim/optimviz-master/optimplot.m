function optimplot(funlog,table,n,stats,X,Y)
...
scatter3(table.xmin(1),table.xmin(2),min(Y)+offset,100,'rd','MarkerFaceColor','r','MarkerEdgeColor','none');    % Minimum
