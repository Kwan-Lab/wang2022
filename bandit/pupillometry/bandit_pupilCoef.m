function bandit_pupilCoef(dataIndex, savefigpath)
...
for ii = 1:nFiles
    ...
    animal = fn_beh.folder(end-2:end);
...
print(gcf,'-dpng','coeff_r_chosenq_time_total');    %png format
saveas(gcf, 'coeff_r_chosenq_time_total', 'fig');
saveas(gcf, 'coeff_r_chosenq_time_total', 'svg');
