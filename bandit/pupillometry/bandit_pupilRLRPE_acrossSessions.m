function bandit_pupilRLRPE_acrossSessions(dataIndex, savefigpath);
...
for ii = 1:nFiles
    ...
    saveRegName = fullfile(savematpath,[fn_beh.name(1:end-7),'regRL_RPE.mat']);
...
tlabel1={'C(n)','QL-QR','C(n-1)','R(n-1)', 'RPE','Average reward', 'Cumulative reward'};
tlabel2={'C(n)','QL-QR','C(n-1)','R(n-1)', 'updatedQ','Average reward', 'Cumulative reward'};
...
print(gcf,'-dpng','MLR-RL_averageSession_RPE');    %png format
saveas(gcf, 'MLR-RL_averageSession_RPE', 'fig');


% plot updatedQ

MP_plot_regrcoef_pupil(reg_all_updatedQ,pvalThresh,tlabel2,xtitle);
print(gcf,'-dpng','MLR-RL_averageSession_updatedQ');    %png format
saveas(gcf, 'MLR-RL_averageSession_updatedQ', 'fig');
...
print(gcf,'-dpng','MLR-RL_RPE');    %png format
saveas(gcf, 'MLR-RL_RPE', 'fig');
...
print(gcf,'-dpng','MLR-RL_updatedQ');    %png format
saveas(gcf, 'MLR-RL_updatedQ', 'fig');
